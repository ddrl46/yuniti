 ...
 * 
 *
 * @method     PostQuery orderByPostid($order = Criteria::ASC) Order by the postid column
 * @method     PostQuery orderByThreadid($order = Criteria::ASC) Order by the threadid column
 * @method     PostQuery orderByPostuserid($order = Criteria::ASC) Order by the postuserid column
 * @method     PostQuery orderByText($order = Criteria::ASC) Order by the text column
 *
 * @method     PostQuery groupByPostid() Group by the postid column
 * @method     PostQuery groupByThreadid() Group by the threadid column
 * @method     PostQuery groupByPostuserid() Group by the postuserid column
 ...
 *
 * @method     Post findOneByPostid(int $postid) Return the first Post filtered by the postid column
 * @method     Post findOneByThreadid(int $threadid) Return the first Post filtered by the threadid column
 * @method     Post findOneByPostuserid(int $postuserid) Return the first Post filtered by the postuserid column
 * @method     Post findOneByText(string $text) Return the first Post filtered by the text column
 *
 * @method     array findByPostid(int $postid) Return Post objects filtered by the postid column
 * @method     array findByThreadid(int $threadid) Return Post objects filtered by the threadid column
 * @method     array findByPostuserid(int $postuserid) Return Post objects filtered by the postuserid column
...
abstract class BasePostQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'yuniti', $modelName = 'Post', $modelAlias = null)
	{
	...
	{
		return $this->addUsingAlias(PostPeer::POSTID, $key, Criteria::EQUAL);
	}
	...
	{
		return $this->addUsingAlias(PostPeer::POSTID, $keys, Criteria::IN);
	}
	...
	public function filterByPostid($postid = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(PostPeer::POSTID, $postid, $comparison);
	}
	...
	public function filterByThreadid($threadid = null, $comparison = null)
	{
		if (is_array($threadid)) {
			...
			if (isset($threadid['min'])) {
				$this->addUsingAlias(PostPeer::THREADID, $threadid['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($threadid['max'])) {
				$this->addUsingAlias(PostPeer::THREADID, $threadid['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(PostPeer::THREADID, $threadid, $comparison);
	}

	/**
	 * Filter the query on the postuserid column
	 * 
	 * @param     int|array $postuserid The value to use as filter.
	 *            Accepts an associative array('min' => $minValue, 'max' => $maxValue)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    PostQuery The current query, for fluid interface
	 */
	public function filterByPostuserid($postuserid = null, $comparison = null)
	{
		if (is_array($postuserid)) {
			$useMinMax = false;
			if (isset($postuserid['min'])) {
				$this->addUsingAlias(PostPeer::POSTUSERID, $postuserid['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($postuserid['max'])) {
				$this->addUsingAlias(PostPeer::POSTUSERID, $postuserid['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(PostPeer::POSTUSERID, $postuserid, $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(PostPeer::THREADID, $thread->getThreadid(), $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(PostPeer::POSTUSERID, $user->getUserid(), $comparison);
	}
	...
	{
		if ($post) {
			$this->addUsingAlias(PostPeer::POSTID, $post->getPostid(), Criteria::NOT_EQUAL);
	  }
